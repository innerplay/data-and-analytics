...
if not all_data.empty:
    ...
    key_columns = ['charge_id', 'created_at', 'etl_load_date']
    ...
    for _, row in all_data.iterrows():
        ...
        new_row['etl_load_date'] = datetime.now(timezone.utc)
    ...
    WHEN NOT MATCHED THEN
        INSERT (charge_id, created_at, data, etl_load_date)
        VALUES (source.charge_id, source.created_at, source.data, source.etl_load_date)
    """
